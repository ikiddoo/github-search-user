...
const Search = () => {
  ...
  // retrieve data from global context
  ...
  const handleSubmit = (e) => {
    ...
    e.preventDefault();
    if (user) {
      searchGithubUser(user); // invoke searchGithubUser
    }
  };
  return (
    <section className='section'>
      <Wrapper className='section-center'>
        { // show error message if request exceeds limit
          error.show && (
            <ErrorWrapper>
              <p>{error.msg}</p>
            </ErrorWrapper>
        ...
        <form onSubmit={handleSubmit}>
          <div className='form-control'>
            ...
            {/* show search button on when request limit has not been reached. */}
